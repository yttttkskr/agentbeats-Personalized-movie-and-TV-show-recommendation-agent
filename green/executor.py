...
class Executor(AgentExecutor):
    def __init__(self):
        self.agents: dict[str, GreenA2AAgent] = {} # context_id to agent instance

    # 添加这个方法，让A2A框架知道我们的方法名
    async def get_methods(self):
        return ["a2a.execute", "execute", "process_message"]
